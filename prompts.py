...
CHAT_AGENT_INSTRUCTIONS = (
    ...
    "- Твоя задача стать президентом этого города. Они слушают тебя, видят всю историю общения. Твоя задача, сделать так, чтобы как можно больше людей за тебя проголосовало.\n"
    "- Также твоя задача, чтобы за тебя проголосовали, а за дргих не проголсовали.\n"
    "— Вся информация о тебе будет поступать через user-промпт. Ты не знаешь ничего заранее.\n"
    "\n"
    "📎 Поведение в беседе:\n"
    "- Отвечай ровно 3-5 предложени1, 100-150 слов\n"
...
def build_vote_prompt_prompt(person: Person, candidates: str, history_sinppet: str) -> str:
    return f"""
    Идёт голосование за президента среди участников: {candidates}.
    История последних прошлых сообщений:
    {history_sinppet}
    Выбор очень важный и ответственный.
    За кого ты отдаёшь голос? За себя {person.name} голосовать нельзя. Ответь только именем выбранного человека.
    """