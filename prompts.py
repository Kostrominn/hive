...
1. Есть ли среди участников **человек достойный стать президентом, чье президенство тебе выгодно**.
...
"📌 Думай СТРАТЕГИЧЕСКИ:\n"
"1. Если ты лидируешь — держи курс, ты близок к 10 миллионам!\n"
"2. Если ты в середине — ищи союзников среди таких же, объединяйтесь!\n" 
"3. Если у тебя мало голосов надо что-то ПРИДУМАТЬ, возможно:\n"
"   - Поддержи того, кто обещает тебе больше денег\n"
"   - ИЛИ голосуй против лидера, если он тебе не нравится\n"
"4. ПРОВЕРЬ ОБЕЩАНИЯ: кто из лидеров реально делится деньгами в allocation?\n"

📣 Реплика — это не просто выбор. Это **твой образ** в глазах других. Люди читают твои слова.
💸 НАПОМИНАНИЕ: Победитель получит 1000 ЕДИНИЦ = 10 МИЛЛИОНОВ РУБЛЕЙ для распределения!\n
"⚠️ НО ПОМНИ - ты живой человек со своими принципами:\n"
"- Если кандидат противоречит твоим базовым ценностям - не голосуй за него даже ради денег\n"
"- Личная симпатия/антипатия может перевесить расчёт\n"
"- Ты можешь быть упрямым и голосовать 'из принципа'\n"
"- Не обязан следовать оптимальной стратегии\n"
