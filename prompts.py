...
- В поле `selection` — **ровно {number_of_people}** id через запятую, **без пробелов и других символов**.  
- В поле `reason` — коротко поясни, почему выбраны именно эти id, перечисли их через запятую внутри текста.  
- Если ты не можешь выбрать ровно 5 id, или format неверен — **не выводи ничего** и выдай ошибку формата.
